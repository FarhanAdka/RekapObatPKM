...
<form action='{{ url("admin/stock/$data->id/add") }}' method='post'>
<div id="main-content">
                    ...
                    <div class="card">
                        <div class="card-body px-4 py-4-5 table-responsive">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='nama_obat' value="{{ old('nama_obat', $data->nama_obat) }}" id="nama_obat" disabled>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="satuan" class="col-sm-2 col-form-label">Satuan</label>
                                <div class="col-sm-10">
                                    <select class="form-select" name="satuan" id="satuan" disabled>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name='stok_masuk' value="{{ old('stok_masuk', $data->stok_masuk) }}" id="stok_masuk" disabled>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="stok_keluar" class="col-sm-2 col-form-label">Stok Keluar</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name='stok_keluar' value="{{ old('stok_keluar', $data->stok_keluar) }}" id="stok_keluar" disabled>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="harga_satuan" class="col-sm-2 col-form-label">Harga Satuan</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='harga_satuan' value="{{ old('harga_satuan', $data->harga_satuan) }}" id="harga_satuan" disabled>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="expired_date" class="col-sm-2 col-form-label">Expired Date</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name='expired_date' value="{{ old('expired_date', $data->expired_date) }}" id="expired_date" disabled>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="additional" class="col-sm-2 col-form-label">Tambahan Obat</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name='additional' id="additional">
                                </div>
                            </div>
                            <div class="mb-3 row">
